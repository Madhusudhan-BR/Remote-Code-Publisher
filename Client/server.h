#pragma once
/////////////////////////////////////////////////////////////////////////
// Server.h      - Implements   simple two-way HTTP style messaging    //
//                 and file transfer                                   //
//                                                                     //
...
public:
	...
	/*void publish(std::vector<std::string>);
	void indexCreator(std::vector<std::string>);*/
private:
...
bool ClientHandler::readFile(const std::string& filename, size_t fileSize, Socket& socket,int category,std::string type)
{
	...
	std::string fqname = "../Client/Repository/PublishedFiles/Category" + std::to_string(category) + '/' + filename ;

	//fqname = fqname + '/' + filename + ".snt";
